 ...
 *  @package    Tomoe
 */
class Tomoe_Controller extends Ethna_Controller
{
    /**#@+
     *  @access private
     */
    ...
    var $class = array(
        ...
        'form'          => 'Tomoe_ActionForm',
        'i18n'          => 'Ethna_I18N',
        'logger'        => 'Ethna_Logger',
        'plugin'        => 'Ethna_Plugin',
        'session'       => 'Ethna_Session',
        'sql'           => 'Ethna_AppSQL',
        'view'          => 'Tomoe_ViewClass',
        'renderer'      => 'Ethna_Renderer_Smarty',
        'url_handler'   => 'Tomoe_UrlHandler',
    );
